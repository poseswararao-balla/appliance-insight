  ...
  return (
    <div className="w-full max-w-md">
      <div className="rounded-3xl border border-border bg-gradient-card p-8 shadow-soft">
        <h1 className="font-display text-3xl font-bold tracking-tight">{t("welcomeBack")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("signIn")} → {t("dashboard")}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            className="h-11 w-full bg-gradient-primary text-base text-primary-foreground shadow-soft hover:opacity-90"
            disabled={loading}
          >
            {loading ? "…" : t("signIn")}
          </Button>
